...
declare class Context {
     ...
     * @type {number}
     */
    _fillColor: CanvasGradient | (typeof NAMED_COLORS)[keyof typeof NAMED_COLORS] | number;
    /**
     * @type {number}
     */
    _strokeColor: NAMED_COLORS;
    /**
     * @type {number}
     */
    _lineWidth: number;
     ...
     * @type {string}
     */
    _fillStyle_text: string;
    /**
     * @type {string}
     */
    _strokeStyle_text: string;
    ...
    */
    ...
    createRadialGradient(x0: number, y0: number): RadialGradient;
    /**
     ...
     * @memberof Context
     */
    composite(i: number, j: number, old_pixel: number, new_pixel: number): number;
    /**
     * Calculate RGBA
     *
     * @param {number} x X position
     ...
     * @memberof Context
     */
    calculateRGBA_stroke(x: number, y: number): NAMED_COLORS;
    /**
     * Get Image Data
     *
     * @param {number} x X position
     ...
     * @memberof Context
     * */
    _bezierCurveTo(cp1: IPoint, cp2: IPoint, pt: IPoint): void;
    /**
