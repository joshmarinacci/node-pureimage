 ...
 */
export declare function fromBytesBigEndian(highByte: number, secondHighByte: number, thirdHighByte: number, lowByte: number): number;
/**
 *  Returns the byte.
 ...
 */
export declare function getByteBigEndian(uint32value: number, byteNo: number): number;
/**
 *  Returns the bytes as array.
 *  @param {Number} uint32value the source to be extracted
 *  @returns {Array} the array [highByte, 2ndHighByte, 3rdHighByte, lowByte]
 */
export declare function getBytesBigEndian(uint32value: number): number[];
/**
 ...
 */
export declare function toHex(uint32value: number, optionalMinLength: number): string;
/**
 *  Converts a number to an uint32.
 *  @param {Number} number the number to be converted.
 *  @return {Number} an uint32 value
 */
export declare function toUint32(number: number): number;
/**
 ...
 */
export declare function highPart(number: number): number;
/**
 ...
 */
export declare function or(uint32val0: number, ...argv: number[]): number;
/**
 ...
 */
export declare function and(uint32val0: number, ...argv: number[]): number;
/**
 ...
 */
export declare function xor(uint32val0: number, ...argv: number[]): number;
export declare function not(uint32val: number): number;
/**
 ...
 */
export declare function shiftLeft(uint32val: number, numBits: number): number;
/**
 *  Returns the uint32 representation of a >>> operation.
 *  @param {Number} uint32val the word to be shifted
 *  @param {Number} numBits the number of bits to be shifted (0-31)
 *  @returns {Number} the uint32 value of the shifted word
 */
export declare function shiftRight(uint32val: number, numBits: number): number;
export declare function rotateLeft(uint32val: number, numBits: number): number;
export declare function rotateRight(uint32val: number, numBits: number): number;
/**
 *  Bitwise choose bits from y or z, as a bitwise x ? y : z
 */
export declare function choose(x: number, y: number, z: number): number;
/**
 ...
 */
export declare function majority(x: number, y: number, z: number): number;
/**
 *  Adds the given values modulus 2^32.
 *  @returns the sum of the given values modulus 2^32
 */
export declare function addMod32(uint32val0: number, ...optionalValues: number[]): number;
/**
 ...
 */
export declare function log2(uint32val: number): number;
/**
 ...
 *  @returns undefined
 */
export declare function mult(factor1: number, factor2: number, resultUint32Array2: number[]): void;
